...
- **transcript flanking** : it is **not** allowed to describe variants in nucleotides beyond the boundaries of the reference sequence using the reference sequence
...
- **introns in 5' untranslated region (UTR)** : e.g. [three introns in the 5'UTR of the FKRP gene](http://www.dmd.nl/seqs/murefFKRP.html), for numbering see [coding DNA numbering](#DNAc)
