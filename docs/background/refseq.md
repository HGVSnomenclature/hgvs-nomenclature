...
- the preferred human mtDNA reference sequence is the [Homo sapiens\_ mitochondrion, complete genome (GenBank NC_012920.1)](http://www.ncbi.nlm.nih.gov/nucleotide/NC_012920.1).: **NOTE:** the mtDNA reference sequence is a **circular molecule** ([see Open Issues](../../consultation/open-issues/#circular))
