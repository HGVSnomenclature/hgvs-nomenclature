...
Variants affecting RNA splicing result in either a [_deletion_](../deletion/) or [_insertion_](../insertion/) on the RNA level and should be described as such. Recommendations on representing chimeric transcripts formed by gene fusions are discussed in the Note below.
